...
@param optional (nil or map[string]interface{}) with one or more of:
    @param "fileComment" (string) File comment to add star to.
    @param "timestamp" (float32) Timestamp of the message to add star to.
    @param "token" (string) Authentication token. Requires scope: &#x60;stars:write&#x60;
    @param "channel" (string) Channel to add star to, or channel where the message to add star to was posted (used with &#x60;timestamp&#x60;).
    @param "file" (string) File to add star to.
@return DefaultSuccessTemplate*/
func (a *StarsApiService) StarsAdd(ctx context.Context, localVarOptionals map[string]interface{}) (DefaultSuccessTemplate, *http.Response, error) {
	var (
...
@param optional (nil or map[string]interface{}) with one or more of:
    @param "count" (string)
    @param "token" (string) Authentication token. Requires scope: &#x60;stars:read&#x60;
    @param "page" (string)
@return DefaultSuccessTemplate*/
func (a *StarsApiService) StarsList(ctx context.Context, localVarOptionals map[string]interface{}) (DefaultSuccessTemplate, *http.Response, error) {
	var (
...
* @param ctx context.Context for authentication, logging, tracing, etc.
@param optional (nil or map[string]interface{}) with one or more of:
    @param "fileComment" (string) File comment to remove star from.
    @param "timestamp" (float32) Timestamp of the message to remove star from.
    @param "token" (string) Authentication token. Requires scope: &#x60;stars:write&#x60;
    @param "channel" (string) Channel to remove star from, or channel where the message to remove star from was posted (used with &#x60;timestamp&#x60;).
    @param "file" (string) File to remove star from.
@return DefaultSuccessTemplate*/
func (a *StarsApiService) StarsRemove(ctx context.Context, localVarOptionals map[string]interface{}) (DefaultSuccessTemplate, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
